...
import addRecord
import searchID
from searchID import display_all_records
...
def setupApplicants(event = None):
    global searchbar_logoFinal, sortButtonImageFinal, addButtonImageFinal, searchButtonImageFinal
    global text_result, searchID_entry, result_frame
    ...
    applicantsPage.create_window(390, 75, anchor="nw", window=searchID_entry)

    searchButtonImagePath = Image.open("Applicants/SearchButton.png")
    searchButtonImageResize = searchButtonImagePath.resize((28, 28))
    searchButtonImageFinal = ImageTk.PhotoImage(searchButtonImageResize)
    searchButton = applicantsPage.create_image(522, 90, image=searchButtonImageFinal)
    applicantsPage.tag_bind(searchButton, "<Button-1>", lambda e: searchID.display_single_record(searchID_entry.get(), result_frame))

    # Scrollable Canvas Frame for results
    result_canvas = tk.Canvas(applicantsPage, width=1000, height=500, bg="white", highlightthickness=0)
    scrollbar = tk.Scrollbar(applicantsPage, orient="vertical", command=result_canvas.yview)
    result_frame = tk.Frame(result_canvas, bg="white")
    ...
    result_canvas.place(x=50, y=250)
    scrollbar.place(x=1050, y=250, height=500)

    searchID.display_all_records(result_frame)
...
def toCatsPage(event = None):
    ...
    catsPage.place(x=336, y=0, width=1440, height=900)#width=1104, height=900
    navigatorPage.place(x=0, y=0, relheight=1)
    setupNavigator()
    ...
    #Cats pictures & names
    sawyerImagePath = Image.open("cats/sawyer.png")
    sawyerImageFinal = ImageTk.PhotoImage(sawyerImagePath)
    catsPage.create_image(348,171, image=sawyerImageFinal, anchor=tk.NW)
    catsPage.create_text(348 + 293//2, 171 + 250 + 20, text="Sawyer", font=("Poppins", 28, "bold"), fill="black", anchor="center")

    sashaImagePath = Image.open("cats/sasha.png")
    sashaImageFinal = ImageTk.PhotoImage(sashaImagePath)
    catsPage.create_image(701,171, image=sashaImageFinal, anchor=tk.NW)
    catsPage.create_text(348 + 293//2, 171 + 250 + 20, text="Sawyer", font=("Poppins", 28, "bold"), fill="black", anchor="center")

    lauraImagePath = Image.open("cats/laura.png")
    lauraImageFinal = ImageTk.PhotoImage(lauraImagePath)
    catsPage.create_image(1054,171, image=lauraImageFinal, anchor=tk.NW)
    catsPage.create_text(1054 + 293//2, 171 + 250 + 20, text="Laura", font=("Poppins", 28, "bold"), fill="black", anchor="center")

    heathImagePath = Image.open("cats/heath.png")
    heathImageFinal = ImageTk.PhotoImage(heathImagePath)
    catsPage.create_image(348,513, image=heathImageFinal, anchor=tk.NW)
    catsPage.create_text(348 + 293//2, 513 + 250 + 20, text="Heath", font=("Poppins", 28, "bold"), fill="black", anchor="center")

    skylerImagePath = Image.open("cats/skyler.png")
    skylerImageFinal = ImageTk.PhotoImage(skylerImagePath)
    catsPage.create_image(701,513, image=skylerImageFinal, anchor=tk.NW)
    catsPage.create_text(701 + 293//2, 513 + 250 + 20, text="Skyler", font=("Poppins", 28, "bold"), fill="black", anchor="center")

    cleoImagePath = Image.open("cats/cleo.png")
    cleoImageFinal = ImageTk.PhotoImage(cleoImagePath)
    catsPage.create_image(1054,513, image=cleoImageFinal, anchor=tk.NW)
    catsPage.create_text(1054 + 293//2, 513 + 250 + 20, text="Cleo", font=("Poppins", 28, "bold"), fill="black", anchor="center")

    cowImagePath = Image.open("cats/cow.png")
    cowImageFinal = ImageTk.PhotoImage(cowImagePath)
    catsPage.create_image(348,865, image=cowImageFinal, anchor=tk.NW)
    catsPage.create_text(348 + 293//2, 1135, text="Cow", font=("Poppins", 28, "bold"), fill="black", anchor="center")

    corneliaImagePath = Image.open("cats/cornelia.png")
    corneliaImageFinal = ImageTk.PhotoImage(corneliaImagePath)
    catsPage.create_image(701,865, image=corneliaImageFinal, anchor=tk.NW)
    catsPage.create_text(701 + 293//2, 1135, text="Cornelia", font=("Poppins", 28, "bold"), fill="black", anchor="center")

    jlImagePath = Image.open("cats/jl.png")
    jlImageFinal = ImageTk.PhotoImage(jlImagePath)
    catsPage.create_image(1054,865, image=jlImageFinal, anchor=tk.NW)
    catsPage.create_text(1054 + 293//2, 1135, text="JL", font=("Poppins", 28, "bold"), fill="black", anchor="center")

    catsPage.sawyerImageFinal = sawyerImageFinal
    catsPage.sashaImageFinal = sashaImageFinal
    catsPage.lauraImageFinal = lauraImageFinal
    catsPage.heathImageFinal = heathImageFinal
    catsPage.skylerImageFinal = skylerImageFinal
    catsPage.cleoImageFinal = cleoImageFinal
    catsPage.cowImageFinal = cowImageFinal
    catsPage.corneliaImageFinal = corneliaImageFinal
    catsPage.jlImageFinal = jlImageFinal
